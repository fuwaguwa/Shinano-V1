            ...
            if (interaction.options.getSubcommandGroup() === 'anime') {
                switch (interaction.options.getSubcommand()) {
                    ...
                    default: {
                        ...
                        const response = await fetch(`https://AmagerAPI.fuwafuwa08.repl.co/nsfw/public/${tag}`, {
                            method: "GET",
                            headers: {
                ...
                const response = await fetch(`https://AmagerAPI.fuwafuwa08.repl.co/nsfw/porn/${tag}`, {
                    method: "GET",
                    headers: {
                        "Authorization": process.env.amagiApiKey
                    }
